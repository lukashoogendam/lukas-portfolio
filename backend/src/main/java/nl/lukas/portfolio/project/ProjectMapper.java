...
public class ProjectMapper {
    ...
    public ProjectListDto toListDto(Project project, String lang, Optional<ProjectTranslation> translation) {
        ...
        return ProjectListDto.builder()
                ...
                .highlighted(project.isHighlighted())
    ...
    private ProjectDetailDto.ShowcaseDto toShowcaseDto(ProjectShowcase sc) {
    ...
    private ProjectDetailDto.DocumentDto toDocumentDto(ProjectDocument doc) {
